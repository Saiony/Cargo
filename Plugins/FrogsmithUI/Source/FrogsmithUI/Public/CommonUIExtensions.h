...
UCLASS()
class FROGSMITHUI_API UCommonUIExtensions : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	static UCommonActivatableWidget* PushContentToLayer_ForPlayer(const ULocalPlayer* LocalPlayer,
	                                                              ...
	                                                              UPARAM(meta = (AllowAbstract = false)) TSubclassOf<UCommonActivatableWidget>
	                                                              WidgetClass);
	...
	UFUNCTION(BlueprintCallable, BlueprintCosmetic, Category = "Global UI Extensions")
	static bool HasWidgetInLayer(const ULocalPlayer* LocalPlayer, TSubclassOf<UCommonActivatableWidget> WidgetClass, FGameplayTag Layer);
